 ...
 */
public class PublicVedioFragment extends BaseFragment implements ILiveVedioContacts.View,RecyclerArrayAdapter.OnLoadMoreListener{
    ...
    protected int getLayoutResource() {
        return R.layout.fragment_public_vedio;
    }

    @Override
    protected void onInitView() {
        data=new ArrayList<VedioDetailsBean>();
        present=new LvListPresent(getActivity(),this, Constants.PUBLIC_VEDIO_NAME);
    ...
    @Override
    public void refresh(List<VedioDetailsBean> data) {
