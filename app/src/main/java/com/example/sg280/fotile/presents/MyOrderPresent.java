...
public class MyOrderPresent implements MyOrderContacts.Present {
    ...
    public void getAll(){
        adapter = new MyOrderAdapter(context,allOrderList);
        recyclerView.setAdapter(adapter);
    }

    public void getWaitPay(){
        adapter = new MyOrderAdapter(context,waitPayList);
        recyclerView.setAdapter(adapter);
    }

    public void getWaitShipments(){
        adapter = new MyOrderAdapter(context,waitShipmentsList);
        recyclerView.setAdapter(adapter);
    }

    public void getWaitReceipt(){
        adapter = new MyOrderAdapter(context,waitReceiptList);
        recyclerView.setAdapter(adapter);
    }

    public void getOrderIsDone(){
        adapter = new MyOrderAdapter(context,orderIsDoneList);
        recyclerView.setAdapter(adapter);
    }
