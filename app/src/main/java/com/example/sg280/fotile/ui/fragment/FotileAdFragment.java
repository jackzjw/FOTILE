 ...
 */
public class FotileAdFragment extends BaseFragment implements ILiveVedioContacts.View,RecyclerArrayAdapter.OnLoadMoreListener{
    ...
    protected int getLayoutResource() {
        return R.layout.fragment_fotilead;
    }

    @Override
    protected void onInitView() {
        data=new ArrayList<VedioDetailsBean>();
        present=new LvListPresent(getActivity(),this, Constants.FOTILE_VEDIO_NAME);
